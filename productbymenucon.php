...
<div class="row" style="margin-top:50px;">
    ...
    <div class="col-md-9">
        <?php
        $menucon_id = isset($_GET['menucon_ID']) ? $_GET['menucon_ID'] : null;

        if ($menucon_id !== null) {
            echo "<div class='row'>";
            $sanphamList = $sp->getSanPhamByMenucon($menucon_id);
                    ...
                    <div class="col-md-4">
                        <div class="card khung-san-pham" style="margin: 10px;margin-top:100px; width: 16rem; height:27rem;">
                            <a href="preview.php?proid=<?php echo $product['sanpham_ID']; ?>">
                                <img style="height:80%;" src="admin/upload/<?php echo $product['image']; ?>" class="card-img-top"
                                    alt="...">
                            </a>
...
?>
                                <p><span class="price">Giá sale
                                    ...
                                    </span> VNĐ</p><a style="background-color: white;" class="aaa"
                                    href="preview.php?proid=<?php echo $product['sanpham_ID'] ?>">
                                    <span></span><span></span><span></span><span></span>Chi tiết</a>
                            </div>
                        </div>
                    </div>
                    <?php
            ...
            echo "Vui lòng chọn một menu con.";
        }
        ?>
    </div>
</div>